...
export function ProfileDrawer({ isOpen, onClose }: ProfileDrawerProps) {
  ...
  return (
    <div className="absolute inset-0 z-50">
      ...
      {/* Drawer */}
      <div className={`absolute inset-y-0 left-0 w-[85%] bg-[#27282B] transform transition-transform duration-300 ease-in-out rounded-l-[3rem] ${isOpen ? 'translate-x-0' : '-translate-x-full'}`}>
